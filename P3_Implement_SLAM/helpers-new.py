...
def display_world(world_size, positions, landmarks=None, true_landmarks=None, true_position=None):
    ...
    ax.plot(positions[:,0],positions[:,1], '-o', ms=20, lw=2, alpha=0.7, mfc='orange')
    ...
    if(true_position is not None):
        ax.text(true_position[0], true_position[1], 'o', ha='center', va='center', color='k', fontsize=30)
    ...
    if(true_landmarks is not None):
        ...
        for pos in true_landmarks:
            ax.text(pos[0], pos[1], 'x', ha='center', va='center', color='blue', fontsize=20)
